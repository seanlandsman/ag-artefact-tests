describe('Grid Tests', () => {
    [
        ...
        {name: 'Modules: Vue 2 Community', path: 'packages/vue2-community/dist', license: false},
        {name: 'Modules: Vue 2 Enterprise', path: 'packages/vue2-enterprise/dist', license: true},
        {name: 'Modules: Vue 3 Community', path: 'packages/vue3-community/dist', license: false},
        {name: 'Modules: Vue 3 Enterprise', path: 'packages/vue3-enterprise/dist', license: true},
        {name: 'Modules: Vue 3 Community Script/Setup', path: 'packages/vue3-community-scriptsetup/dist', license: false},
